...
\end{equation}
%
These one-dimensional targets have to be sampled by MCMC too. Alternatively, one can use a a Hamiltonian Monte Carlo scheme using the gradient (in case of a Gamma prior over $g$ with parameters shape $k$ and scale $\theta$):
