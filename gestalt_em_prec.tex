...
\frac{\partial C_v^m}{\partial \left[ U_k \right]_{a,b}} = 2 g_k^m \left[ U_k \right]_{a,b}
\end{eqnarray}
%
...
\begin{equation}
\begin{split}
&\frac{\partial \mathcal{L}}{\partial \left[ U_k \right]_{a,b}} = -\frac{1}{2L} \sum_{m=1}^{NL} \textrm{Tr} \left[ \frac{\partial \mathcal{L}^m}{\partial C_v^m} \frac{\partial C_v^m}{\partial \left[ U_k \right]_{a,b}} \right] = \\
& -\frac{1}{L} \sum_{m=1}^{LN} \textrm{Tr} \left[ g_k^{m} \left[ U_k \right]_{a,b} \left[ B \left( C_v^m \right)^{-1} - \sum_{b=1}^B \left( C_v^m \right)^{-1} v^{m,b} v^{(m,b)T} \left( C_v^m \right)^{-1} \right] \right] = \\
& -\frac{ \left[ U_k \right]_{a,b}}{L} \sum_{m=1}^{LN} g_k^{m} \textrm{Tr} \left[ B \left( C_v^m \right)^{-1} -  \left( C_v^m \right)^{-1} \left( \sum_{b=1}^B v^{m,b} v^{(m,b)T} \right) \left( C_v^m \right)^{-1} \right]
\end{split}
\end{equation}
%
...
\begin{equation}
\left[ U_k \right]_{a,b}^{new} = \left[ U_k \right]_{a,b}^{old} + \epsilon \frac{\partial \mathcal{L}}{\partial \left[ U_k \right]_{a,b}}
\end{equation}
