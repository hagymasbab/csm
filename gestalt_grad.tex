...
\begin{equation}
p(X \mid C_{1..K}) \approx \prod_{n=1}^N \sum_{l=1}^{L} \int_{-\infty}^{\infty} p(x_n,v_n \mid z^l,g^l)  \mathrm{d}v_n
\end{equation}
%
...
\begin{eqnarray}
p(X \mid C_{1..K}) \approx \prod_{n=1}^N \sum_{l=1}^{L} h(z^l) \mathcal{N}(f(x_n,z^l);0,C(z^l,g^l)) \\
\log p(X \mid C_{1..K}) \approx \sum_{n=1}^N \log \left[ \sum_{l=1}^{L} h(z^l) \mathcal{N}(f(x_n,z^l);0,C(z^l,g^l)) \right] \\
