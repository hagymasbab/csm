...
\begin{equation}
\begin{split}
\frac{\partial}{\partial g_k} \log p(g,z \mid x) = \mathrm{Tr} \left[ \frac{\partial}{\partial C_x} \log p(g,z \mid x) \frac{\partial C_x}{\partial g_k} \right] + \frac{\alpha_g-1}{g_k} - \frac{g_k}{\theta_g} = \\
= z^2 \mathrm{Tr} \left[ \left[ C_x^{-1} - C_x^{-1} xx^T C_x^{-1} \right] AU_k^TU_kA^T \right] + \frac{\alpha_g-1}{g_k} - \frac{g_k}{\theta_g}
\end{split}
\end{equation}
%
...
\begin{equation}
\begin{split}
\frac{\partial}{\partial z} \log p(g,z \mid x) = \mathrm{Tr} \left[ \frac{\partial}{\partial C_x} \log p(g,z \mid x) \frac{\partial C_x}{\partial z} \right] + \frac{\alpha_z-1}{z} - \frac{z}{\theta_z} = \\
= 2z \mathrm{Tr} \left[ \left[ C_x^{-1} - C_x^{-1} xx^T C_x^{-1} \right] A C_v A^T \right] + \frac{\alpha_z-1}{z} - \frac{z}{\theta_z}
\end{split}
\end{equation}
