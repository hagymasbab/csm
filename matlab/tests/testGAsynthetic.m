function testGAsynthetic(Dx,k,learningRate,N_all,batchSize,priorSamples,testLike,noiseLevel,initNoise,doubling)
    ...
    gestaltGradientAscent(ge,ge.X,batchSize,8,'priorSamples',priorSamples,'verbose',2,'likeComp','batch','testLike',testLike, ...
        ...
        'initSigma',noiseLevel,'initNoise',initNoise,'adjustBatchSize',doubling);
end